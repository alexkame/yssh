 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/oa/testBaoXiaoAudit")
public class TestBaoXiaoAuditController extends BaseController {

	@Autowired
	private TestBaoXiaoAuditService testAuditService;
...
//			testAudit = testAuditService.getByProcInsId(procInsId);
	...
	public String form(TestAudit testAudit, Model model) {
		...
		String view = "testBaoXiaoAuditForm";
