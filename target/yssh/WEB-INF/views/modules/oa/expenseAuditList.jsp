...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>标题</th><th>原因</th><th>部门领导签字</th><th>老总签字</th><th>财务签字</th><shiro:hasPermission name="oa:testAudit:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="testAudit">
			<tr>
				<td>${testAudit.title}</td>
				<td>${testAudit.yuanyin}</td>
				<td>${testAudit.stepOne}</td>
				<td>${testAudit.stepTwo}</td>
				<td>${testAudit.stepThree}</td>
